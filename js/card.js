...
(function () {
  ...
  var renderOfferDialogFeatureDomElements = function (features) {
    var featureElement;
  ...
  window.card.renderOfferDialog = function (advertElement, advertTypes) {
    ...
    newOfferDialogPanelDomElement.querySelector('.lodge__price').textContent = advertElement.offer.price + window.data.getSign('RUBLE') + '/ночь';
    ...
    newOfferDialogPanelDomElement.querySelector('.lodge__features').appendChild(renderOfferDialogFeatureDomElements(advertElement.offer.features));
